...
import ubicacion from '../../assets/images/araza/ubicacion.png'
    ...
    return(
        ...
        <div className="container">
            ...
            <div className="dvSeccionTextoDerecha">
                <h2 className='hdSeccionTexto hdTextoDerecha'>ARQUITECTURA + PAISAJE: EL VEGETAL<span className='spanParteF'>COMO PARTE FUNDAMENTAL </span>DEL DISEÑO ARQUITECTÓNICO</h2>
            ...
            <div className="dvSeccionTextoIzquierda">
                <h2 className='hdSeccionTexto hdTextoIzquierda'>ARAZÁ ES UN ESPACIO DONDE LA ARQUITECTURA Y LA NATURALEZA CONVIVEN</h2>
            ...
            <div className="dvSeccionFruto">
                <img id='imgArazaFruto' src={arazaFruto} alt='ArazaUrbanicaUruguay' />
            ...
            <div className="dvSeccionUbicacion">
                ...
                <div className="dvHeadingUbicacion">
                    <img id='imgUbicacion' src={ubicacion} alt='ArazaUrbanicaUruguay' />
                ...
                <p id='pubD'>Lejos del ruido pero con rápido acceso a todos los servicios que ofrece el centro. A una cuadra de la renovada Avda. Luis Alberto de Herrera, que se transformó en el principal eje comercial de la ciudad.
                    <br /><span>A pasos de todos los servicios públicos, peatonales, colegios y de las 4 principales plazas de San José de Mayo.</span>
                </p>
                <img id='imgUbicacionAraza' src={ubicacionAraza} alt='ArazaUrbanicaUruguay' />
            </div>
